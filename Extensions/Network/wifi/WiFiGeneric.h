...
#ifndef COMPONENTS_ESP32_SYSTEM_EXTENSIONS_WIFI_WIFIGENERIC_H_
#define COMPONENTS_ESP32_SYSTEM_EXTENSIONS_WIFI_WIFIGENERIC_H_
...
ESP_EVENT_DECLARE_BASE(ARDUINO_EVENTS); // ToDo: check it what is it
...
// ToDo: Below move to Ethernet
	ARDUINO_EVENT_ETH_START,
	ARDUINO_EVENT_ETH_STOP,
	ARDUINO_EVENT_ETH_CONNECTED,
	ARDUINO_EVENT_ETH_DISCONNECTED,
// ToDo Above move to Ethernet

// ToDo: Below move to IP protocol
	ARDUINO_EVENT_ETH_GOT_IP,
	ARDUINO_EVENT_ETH_GOT_IP6,
// ToDo: Above move to IP protocol
...
// ToDo: move events below to IP
	ip_event_got_ip_t got_ip;
	ip_event_got_ip6_t got_ip6;
// Move events above to IP

	smartconfig_event_got_ssid_pswd_t sc_got_ssid_pswd;

// ToDo: move next event to ethernet
...
class class_WiFiGeneric {
public:
	class_WiFiGeneric();
	virtual ~class_WiFiGeneric();
...
public:
/* move to protocols/DNS;
  static int hostByName(const char *aHostname, IPAddress &aResult);

/ * move to protocols/ipv4;
  static IPAddress calculateNetworkID(IPAddress ip, IPAddress subnet);
  static IPAddress calculateBroadcast(IPAddress ip, IPAddress subnet);
  static uint8_t calculateSubnetCIDR(IPAddress subnetMask);
*/
protected:
  friend class WiFiSTA;
  friend class WiFiScan;
  friend class WiFiAP;
...
#endif /* COMPONENTS_ESP32_SYSTEM_EXTENSIONS_WIFI_WIFIGENERIC_H_ */
